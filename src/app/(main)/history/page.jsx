...
export default function History() {
  const milestones = [
    ...
    {
      year: "2025",
      title: "Record ICPC Participation",
      description:
        "In 2025, CPCCU achieved a major milestone with 30 teams registered for the ICPC. This record participation reflects the growing enthusiasm and strength of the competitive programming community at City University.",
    },
    {
      year: "2024",
      title: "Growing Competitive Presence",
      description:
        "In 2024, CPCCU registered 20 teams for the ICPC, demonstrating rapid growth in participation and the increasing interest of students in competitive programming contests.",
    },
    {
      year: "2023",
      title: "Alumni Engagement",
      description:
        "Graduated members began contributing back to the community through mentorship, guidance, and occasional donations to support club activities.",
    },
    {
      year: "2023",
      title: "Community Growth & National Participation",
      description:
        "In 2023, the community expanded significantly. CPCCU registered 3 teams in NCPC, while regular coding sessions, peer learning activities, and programming discussions became part of the club culture.",
    },
    {
      year: "2023",
      title: "ICPC Growth & Second ICPC Participation",
      description:
        "In 2023, the community expanded significantly. CPCCU registered 18 teams in ICPC , while regular coding sessions, peer learning activities, and programming discussions became part of the club culture.",
    },
    {
      year: "2022",
      title: "First ICPC Participation",
      description:
        "In 2022, CPCCU participated in the ICPC for the first time with 2 teams registered. This milestone marked the club’s entry into international-level programming competitions.",
    },
    {
      year: "2022",
      title: "The Beginning",
  ...
  return (<main className="padding py-20 bg-white min-h-screen"> <section className="max-w-5xl mx-auto">
    ...
    <div className="mb-16">
      ...
      <p className="text-gray-700 leading-relaxed text-lg">
        ...
        The journey began when Md Shoriful Islam Ashiq (CSE 60), along
        with Khandakar Amir Hamza (CSE 58), and Roudra Mondal (CSE 60), Md Anisur Rahman Anik (CSE 61),  laid the foundation of a vision that
        continues to grow, inspire, and unite. CPCCU stands as the identity
        of the competitive programmer's community, dedicated to nurturing
          ...
          {milestones.map((milestone, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Content */}
                <div
                  className={`pl-16 md:pl-0 ${isLeft
